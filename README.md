...
- [ ] Explain what a token is used for.
    ...
    A:  A token is used to authenticate a user and keep them logged in.

- [ ] What steps can you take in your web apps to keep your data secure?

    A:  You can have authentication through JWTs or cookies.

- [ ] Describe how web servers work.

    A:  They allow computers to access their data on the internet.
